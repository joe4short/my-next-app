...
//   const setFailedAttempts = (username: string, attempts: number) =>
//     Cookies.set(`failedAttempts_${username}`, attempts.toString(), { expires: 0.02 });
//   const setLockoutEndTime = (username: string, endTime: number) =>
//     Cookies.set(`lockoutEndTime_${username}`, endTime.toString(), { expires: 0.02 });
...
//       router.push(`/profile/someUserID`);
//     } catch (error) {
...
//   return (
//     <LoginWrapper>
//       <LoginMessage message={message} isLocked={isLocked} timeRemaining={timeRemaining} />
